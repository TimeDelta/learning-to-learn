...
class DynamicOptimizerModule(ScriptModule):
    def __init__(self, genome, input_keys, output_keys):
        ...
        create_fn = getattr(torch._C, "_jit_create_method_from_graph",
                    getattr(torch._C, "_create_method_from_graph",
                    getattr(torch._C, "_jit_create_function_from_graph",
                    getattr(torch._C, "_create_function_from_graph"))))
